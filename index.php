...
if (!(file_exists('config.php') && file_exists('functions.php'))) {
	http_response_code(503); header('Content-Type: text/plain; charset=utf-8'); header('Refresh: 5;url=');
...
<head>
	...
	<meta name="description" content="PanDownload 分享链接在线解析工具。" />
	<meta name="keywords" content="PanDownload,下载,不限速" />
